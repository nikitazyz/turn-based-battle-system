    ...
    public class AbilityEffectListPropertyDrawer : UnityEditor.Editor
    {
        ...
        private void AddEffect(SerializedProperty[] listEffects, string assetPath)
        {
            ...
            foreach (var type in types)
            {
                ...
                bool exists = listEffects.Any(serializedProperty => type.IsInstanceOfType(serializedProperty.objectReferenceValue));
                ...
                genericMenu.AddItem(new GUIContent(type.Name), false, () => AddAbilityEffect(type, assetPath, serializedAbility));
            }
            ...
            foreach (var type in types)
            {
                ...
                SerializedObject serializedAbility = serializedObject;
                genericMenu.AddItem(new GUIContent(attribute.MenuName), false, () => AddAbilityEffect(type, assetPath, serializedAbility));
            }
